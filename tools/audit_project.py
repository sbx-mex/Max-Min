...
required = [
    ...
    "vendor/jspdf.umd.min.js", "data/manifest.js", "tools/build_data.py",
...
if manifest["weeks"] != list(range(1, 35)):
    fail("las semanas no son 1-34")
if counts["directoryStores"] != 968 or counts["storesWithData"] != 954:
    fail("conteo inesperado de tiendas")
if counts["ingredients"] != 701 or counts["categories"] != 20:
    fail("conteo inesperado de ingredientes o categorías")
